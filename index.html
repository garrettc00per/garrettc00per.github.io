...
* Co-led a study identifying XPO1 as a therapeutic vulnerability in Wilms tumor through extensive experimental follow-up and NGS analysis, contributing to the initiation of a Phase II clinical trial.
* Developed and validated bioinformatics pipelines for NGS data processing and variant functional scoring using Python, R, and AWS to manage and analyze large-scale genomic datasets.
* Completed an industry internship at GRAIL, contributing to whole-genome bisulfite sequencing platform validation for liquid biopsy applications.
